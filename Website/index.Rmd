...
#median gross rent
Gross_Rent <-
ggplot(mn_acs_ss_act_pred, aes(fill = med_gross_rent)) + 
  geom_sf(color = NA) + 
  scale_fill_viridis_c(option = "magma", labels = scales::dollar) +
...
#total expenditure
Expenditure <-
ggplot(mn_acs_ss_act_pred, aes(fill = TOTALEX)) + 
  geom_sf(color = NA) + 
  scale_fill_viridis_c(option = "magma", labels = scales::dollar) +
...
Local_Revenues <-
ggplot(mn_acs_ss_act_pred, aes(fill = LOCROTH)) + 
  geom_sf(color = NA) + 
  scale_fill_viridis_c(option = "magma", labels = scales::dollar) +
...
Support_Spending <-
ggplot(mn_acs_ss_act_pred, aes(fill = TCURSSC)) + 
  geom_sf(color = NA) + 
  scale_fill_viridis_c(option = "magma") +
